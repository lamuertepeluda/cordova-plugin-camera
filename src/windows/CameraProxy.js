                ...
                if (!CaptureNS.CameraCaptureUI) {
                    ...
                    var _compensateRotation = function () {
                        if (navigator.appVersion.indexOf("Windows Phone 8.1") >= 0 && capture !== null) {
                            ...
                            var orientation = display.DisplayProperties.currentOrientation;
                            switch (orientation) {
                    ...
                    var destroyCameraPreview = function () {
                        if (navigator.appVersion.indexOf("Windows 8.1") >= 0) {
                            Windows.Graphics.Display.DisplayProperties.removeEventListener('orientationchanged', _compensateRotation);
                        }
